...
import React from 'react'; // Removed useRef as we simplify animations
import Image from 'next/image';
import Link from 'next/link';
import { motion } from 'framer-motion';
import {
    FiCheckCircle, FiUsers, FiBriefcase, FiTrendingUp, FiShield,
    FiMessageSquare, FiArrowRight, FiCalendar, FiBookOpen, FiAward, FiHeart, FiZap // Added FiAward, FiHeart
} from 'react-icons/fi';

// Helper function to darken a hex color (for button gradient if used)
...
const TheWorkingMindPage = () => {
    ...
    // Simplified Framer Motion variants based on your last provided code
    const sectionVariants = {
        hidden: { opacity: 0, y: 20 },
        visible: {
            opacity: 1,
            y: 0,
            transition: { duration: 0.6, ease: "easeOut", staggerChildren: 0.15 } // Adjusted stagger
        }
    };
    ...
    const benefits = [
        {
            ...
            points: [
                ...
                // "Proactively address psychosocial risks and promote psychological safety." // Kept it slightly shorter
            ],
            accentColor: "#37b048"
        },
        {
            ...
            points: [
                ...
                "Understand how to manage mental health accommodations.", // Simplified
                "Foster a psychologically safe team environment for open dialogue.",
                // "Enhance leadership capabilities in promoting team well-being and performance."
            ],
            accentColor: "#2c7a7b"
        },
        {
            target: "For Employees",
            icon: FiHeart, // Changed from FiUsers for a more personal touch
            points: [
                ...
                // "Access tools and resources for self-care and maintaining well-being."
            ],
            accentColor: "#dd6b20"
        }
    ];
    ...
    const programOfferings = [
        {
            ...
            icon: FiShield,
            image: "/images/blue_book.png", // Placeholder
            borderColor: "#37b048"
        },
        {
            ...
            icon: FiUsers, // Changed from FiZap for clarity
            image: "/images/red_hammer.png", // Placeholder
            borderColor: "#2c7a7b"
        }
    ];

    return (
        <div style={{ fontFamily: '"Lato", sans-serif', color: '#4A4A4A', backgroundColor: '#fdfdff' }}> {/* Base background */}
            ...
            <motion.section
                style={{
                    position: 'relative',
                    width: '100%',
                    minHeight: 'calc(65vh - 64px)', // Slightly reduced
                    maxHeight: '600px',
                ...
                initial="hidden"
                animate="visible"
                variants={sectionVariants} // This section animates its children
            >
                <Image
                    src="/images/office.webp" // Default placeholder if pond.webp causes issues
                    alt="Supportive Workplace Environment"
                    fill
                    style={{ objectFit: 'cover', filter: 'brightness(0.65)' }}
                    priority
                />
                <div style={{ position: 'relative', zIndex: 1, maxWidth: '750px' }}> {/* Wrapper for hero content */}
                    <motion.h1
                        variants={itemVariants}
                        style={{
                            fontSize: 'clamp(2.2rem, 5.5vw, 3.6rem)', // Scaled
                            fontWeight: 'bold', // Kept bold for impact
                            lineHeight: 1.2,
                            marginBottom: '1rem',
                    ...
                    <motion.p
                        variants={itemVariants}
                        style={{
                            fontSize: 'clamp(1.1rem, 2.5vw, 1.3rem)', // Scaled
                            marginBottom: '2rem',
                            maxWidth: '650px',
            ...
            <motion.section
                id="intro-twm"
                style={{ padding: 'clamp(2.5rem, 6vw, 4rem) clamp(1rem, 4vw, 2rem)', textAlign: 'center', backgroundColor: '#fff' }} // White background
                whileInView={{ opacity: 1, y: 0, transition: { duration: 0.6, ease: "easeOut", delay:0.1, staggerChildren: 0.2 } }} // whileInView for subsequent sections
                viewport={{ once: true, amount: 0.1 }}
                variants={sectionVariants} // Still useful for staggerChildren
            >
                <motion.p
                    variants={itemVariants}
                    style={{ fontSize: 'clamp(1.05rem, 2vw, 1.2rem)', lineHeight: 1.7, maxWidth: '800px', margin: '0 auto 1.5rem auto', color: '#4A4A4A' }}
                >
                    In today&apos;s demanding work environments, prioritizing mental health isn&apos;t just a benefit—it&apos;s a necessity for a thriving, productive, and resilient workforce. &quot;The Working Mind&quot; (TWM), developed by the Mental Health Commission of Canada, offers a transformative approach to workplace mental wellness.
                </motion.p>
                 <motion.p
                    variants={itemVariants}
            ...
            <motion.section
                ...
                viewport={{ once: true, amount: 0.05 }} // amount: 0.05 means even a little bit triggers it
                        ...
                        return (
                            <motion.div
                                ...
                                style={{
                                    ...
                                    padding: '2rem 1.5rem',
                                    borderRadius: '12px',
                                    boxShadow: '0 8px 20px rgba(0, 70, 30, 0.06)', // Softer shadow
            ...
            <motion.section
                ...
                style={{
                    ...
                    backgroundColor: '#384249', // Solid dark background
            ...
            >
                ...
                >
                    &quot;The Working Mind&quot; is more than just training; it&apos;s a catalyst for cultural change. This evidence-based program is designed to:
                </motion.p>
                <div style={{
                    display: 'grid',
                    ...
                    {[
                        ...
                        { icon: FiZap, title: "Enhance Coping Skills", text: "Equip with effective strategies for stress management and resilience." }, // Changed icon
            ...
            <motion.section
                ...
                style={{
                    ...
                    backgroundColor: '#2c3e50', // Consistent dark CTA background
                    color: '#f0f8ff',
                    textAlign: 'center',
                }}
                initial="hidden"
            ...
            >
                ...
                >
                    Partner with Michelle Harding to implement "The Working Mind." Let&apos;s create a culture where every individual feels supported, understood, and empowered to bring their best self to work.
                </motion.p>
                <motion.div variants={itemVariants} style={{ display: 'flex', justifyContent: 'center', gap: '1.25rem', flexWrap: 'wrap' }}>
