                ...
                <div style={{
                    ...
                    <div style={{ marginBottom: '1.5rem' }}>
                        ...
                        <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                            <li><Link href="/" passHref><span style={linkStyle} className="footer-link">Home</span></Link></li>
                            <li><Link href="/about" passHref><span style={linkStyle} className="footer-link">About Michelle</span></Link></li>
                            <li><Link href="/workshops" passHref><span style={linkStyle} className="footer-link">Workshops</span></Link></li>
                            <li><Link href="/programs/the-working-mind" passHref><span style={linkStyle} className="footer-link">The Working Mind</span></Link></li>
                            <li><Link href="/contact" passHref><span style={linkStyle} className="footer-link">Contact</span></Link></li>
                        </ul>
                    </div>
